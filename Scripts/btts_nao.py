...
try:
    ...
    dados_concatenados = pd.concat([dados_existentes, BTTS_Nao], ignore_index=True)
    ...
    BTTS_Nao.to_excel(f'ApostasGeradas\\{amanha}_entradas.xlsx', index=False)
BTTS_Nao
